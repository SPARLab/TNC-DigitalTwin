...
|---|-------|------|--------|----------|-------|
| **28** | **1** | **🐛 iNaturalist: Detail View Crash on Observation Click** | **🔴** | **Critical** | **NEXT: Page crashes when clicking observation card to open detail view. Filters sync correctly; crash occurs on detail view open. Fix before any other work.** |
...
**🔴 Next (critical):** Task 28 — Fix iNaturalist detail view crash on observation click  
