...
**Last Updated:** February 17, 2026 (Phase 3 Dendra status correction)  
...
| 26 | 3 | **Dendra: Task 3.5 — Floating time series chart** | ✅ | High | Complete. 3.5a–3.5c ✅; 3.6–3.9 ✅ (time filter, Save View, fixes). Phase 3 Dendra fully implemented. See phase-3-dendra.md. |
...
| 4. DataOne | 🟡 In Progress | 3 / 6 tasks | `v2/dataone` | No |
