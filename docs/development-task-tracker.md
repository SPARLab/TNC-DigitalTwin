...
| 17b | 1 | **iNaturalist: Add Clear All to Legend Widget** | ✅ | Low | Completed: added Clear All + Select All to legend and browse filters; emerald theme; bidirectional sync with Map Layers widget |
