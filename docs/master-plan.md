...
| 4 | DataOne | 🟡 In Progress | 13 remaining | `v2/dataone` | No |
...
| 4 | [phase-4-dataone.md](IMPLEMENTATION/phases/phase-4-dataone.md) | CON-DONE-03 next (cluster popup); 13 others |
