...
|------|-------|--------|-----|
| Feb 26, 2026 | Phase 7 | **CON-FEB25-03 complete.** Collapsable Edit Filters: applied `collapsible defaultExpanded` to EditFiltersCard in ANiML, Dendra, DataONE, GBIF, CalFlora browse tabs; iNaturalist already had it. Phase 7: 2/9 tasks complete. | Cursor |
