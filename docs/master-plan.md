...
| 4 | DataOne | 🟡 In Progress | 3 tasks | `v2/dataone` | No |
...
| 4 | [phase-4-dataone.md](IMPLEMENTATION/phases/phase-4-dataone.md) | CON-DONE-01/02/06/07/08/09/10/14/16 ✅, D20-09 ✅, TF-13 ✅, TF-14 ✅; remaining: CON-DONE-11, 15, D20-B02 |
